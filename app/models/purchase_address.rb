class PurchaseAddress
  ...
  attr_accessor :user_id, :item_id, :postal_code, :delivery_id, :municipality, :address, :building_name, :phone_number, :token
  ...
  def save
    ...
    Address.create(postal_code: postal_code, delivery_id: delivery_id, municipality: municipality, address: address,
